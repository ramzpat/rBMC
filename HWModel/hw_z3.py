...
MemOp = 	DeclareSort('MemOp')			# Memory operation 	*generated by Instr
AtomicOp =	DeclareSort('AtomicOp')			# Atomic operation 	*generated by Instr
FenceOp =	DeclareSort('FenceOp')			# Fence operation 	*generated by Instr 
...
# Functions 
# Wrapper functions
memOp =		Function('memOp', MemOp, Instr)			# MemOp is a subsort of Instr
atomicOp =	Function('atomicOp', AtomicOp, Instr) 	# AtomicOp is a subsort of Instr
fenceOp =	Function('fenceOp', FenceOp, Instr)		# fenceOp is a subsort of Instr
...
issue_proc =	Function('issue_proc', Instr, Proc)
...
po =			Function('po', Instr, Instr, BoolSort())			# Program order (Instr and MemOo?)
...
# Value casting
Instr.cast = (lambda val:
		val if (val.sort() == Instr)
...
issue_proc.domain = (lambda i: Instr)
