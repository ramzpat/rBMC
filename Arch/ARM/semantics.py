...
def __ldrSemantics__(*operands):
	...
	return __condSemantics__(cond, sem)
...
def __strSemantics__(*operands):
	...
	sem = [(sem1,sem2)]
	sem += [ WriteAssn((Exp('address')), Exp('val')) ]	# write access to location
	return __condSemantics__(cond, sem)
...
def __bSemantics__(*operands):
	...
	return __condSemantics__(cond, gotoSem(label.label_name))
...
if __name__ == '__main__':
	...
	# strne r1, [r2]
	i2 = ARMInstr(ARMInstr.str, ARMCond.ne, (ARMReg.r1), Location(ARMReg.r2))
